...
pub const COMMAND_REGISTRY = [_]CommandInfo{
    ...
    .{ .name = "lint", .args = "[input.ss] [--fix] [--dry-run] [--strict] [--summary] [--format json|sarif] [--rules <file>]", .description = "Lint schema for quality issues (75 rules)" },
...
pub const COMMAND_HELP = [_]CommandHelp{
    ...
    .{
        ...
        .description = "Lint schema for quality issues (75 rules)",
        .options = &.{
