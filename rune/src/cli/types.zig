...
pub const Command = union(enum) {
    ...
    lint: struct { input: ?[]const u8 = null, input2: ?[]const u8 = null, json_errors: bool = false, strict: bool = false, format: LintFormat = .text, rules: ?[]const u8 = null, fix: bool = false, dry_run: bool = false, show_rules: bool = false, init_config: bool = false, include_views: bool = false },
...
pub const COMMAND_HELP = [_]CommandHelp{
    ...
    .{
        ...
        .options = &.{
            ...
            "  --fix           Auto-fix fixable issues (9 rules)",
