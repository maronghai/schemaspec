...
const SQL_RESERVED_WORDS = [_][]const u8{
    ...
    "in", "between", "like", "order", "group", "by", "having",
    ...
    "is", "true", "false", "exists", "case", "when", "then",
    "else", "end", "into", "values", "set", "grant", "revoke",
    "commit", "rollback", "begin", "transaction", "savepoint",
    "if", "else", "while", "for", "loop", "return", "function",
    "procedure", "trigger", "event", "temp", "temporary",
    "replace", "recursive", "cube", "rollup", "grouping",
    "window", "over", "partition", "rows", "range", "current",
    "preceding", "following", "unbounded", "row", "rows",
    "fetch", "first", "next", "only", "with", "lateral",
    "cross", "natural", "using", "asc", "desc", "nulls",
    "first", "last", "limit", "offset", "top", "percent",
