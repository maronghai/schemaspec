...
The lint module (`rune lint`) analyzes `.ss` schemas for quality issues. It runs after semantic analysis and produces diagnostic results. Supports 66 rules, 11 auto-fixable, with `--show-rules` and `--init` for discoverability.
