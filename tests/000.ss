...
# infra_codegen_column : 代码生成表字段定义
id N ++ : 编号
table_id N @ : 表编号
...
# system_operate_log : 操作日志记录 V2 版本
id N ++ : 日志主键
trace_id s64 : 链路追踪编号
user_id N @ : 用户编号
user_type n =0 : 用户类型
