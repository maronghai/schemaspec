...
CREATE TABLE "product" (
  ...
  "price" DECIMAL(16, 2) NOT NULL /* 单价（分） */,
...
CREATE TABLE "order" (
  "id" INTEGER NOT NULL PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
  "order_no" VARCHAR(64) NOT NULL /* 唯一订单号 */,
  "user_id" INTEGER NOT NULL /* 下单用户 */,
  "amount" DECIMAL(16, 2) NOT NULL /* 订单总额（分） */,
  "discount" DECIMAL(20, 6) NOT NULL DEFAULT 0 /* 折扣金额（分） */,
  "note" VARCHAR(512) NOT NULL /* 买家留言 */,
