...
CREATE TABLE "user" (
  ...
  "avatar" CLOB /* 头像 URL */,
  "is_admin" NUMBER(1) DEFAULT 0 /* 管理员标记 */,
  "balance" NUMBER(16, 2) DEFAULT 0 /* 账户余额（分） */,
  "settings" CLOB /* JSON 用户偏好 */,
  "version" NUMBER(19),
...
CREATE TABLE "product" (
  ...
  "stock" NUMBER(10) DEFAULT 0 /* 库存数量 */,
  "category_id" NUMBER(10) /* 分类 ID */,
  "version" NUMBER(19),
  "status" NUMBER(10) DEFAULT 0,
  "delete_at" TIMESTAMP,
  "create_at" TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "order" (
  ...
  "user_id" NUMBER(10) /* 下单用户 */,
  "amount" NUMBER(16, 2) NOT NULL /* 订单总额（分） */,
  "discount" NUMBER(20, 6) DEFAULT 0 /* 折扣金额（分） */,
  "note" VARCHAR2(512) /* 买家留言 */,
  "paid_on" DATE /* 支付日期 */,
  "version" NUMBER(19),
  "status" NUMBER(10) DEFAULT 0,
  "delete_at" TIMESTAMP,
