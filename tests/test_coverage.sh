...
run_suite "PostgreSQL (83 tests)" "bash tests/test_postgres.sh"
run_suite "SQLite (24 tests)" "bash tests/test_sqlite.sh"
run_suite "Migration (34 tests)" "bash tests/test_migrate.sh"
run_suite "Diff (12 tests)" "bash tests/test_diff.sh"
run_suite "Reverse (15 tests)" "bash tests/test_reverse.sh"
...
run_suite "Round-trip (23 tests)" "bash tests/test_roundtrip.sh"
