...
**Current version**: 0.332.0 (2026-08-23) — 71,900+ lines of Zig (47,000+ production + 24,800+ tests across 331 `.zig` files), 2,094 unit tests, 85 lint rules, 112 `REVERSE_MAP` entries, 42 golden inputs (36 runner-covered suites), 12 generators × 6 dialects.
