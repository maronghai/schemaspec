...
**Current version**: 0.335.0 (2026-08-25) — 72,100+ lines of Zig (47,200+ production + 24,900+ tests across 334 `.zig` files), 2,117 unit tests, 85 lint rules, 112 `REVERSE_MAP` entries, 44 golden inputs (36 runner-covered suites), 12 generators × 6 dialects.
