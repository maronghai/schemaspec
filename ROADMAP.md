...
**Current version**: 0.334.0 (2026-08-25) — 72,100+ lines of Zig (47,200+ production + 24,900+ tests across 334 `.zig` files), 2,111 unit tests, 85 lint rules, 112 `REVERSE_MAP` entries, 43 golden inputs (36 runner-covered suites), 12 generators × 6 dialects.
