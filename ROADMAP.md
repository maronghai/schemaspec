...
**Current version**: 0.330.0 (2026-08-23) — 71,600+ lines of Zig (46,800+ production + 24,700+ tests across 330 `.zig` files), 2,091 unit tests, 85 lint rules, 112 `REVERSE_MAP` entries, 39 golden inputs (36 runner-covered suites), 12 generators × 6 dialects.
...
| Maintenance & Release Hygiene | ✅ Complete (11/11) | 11/11 | 0 |
| **Total** | | **159/159** | **0** |
