...
**Current version**: 0.331.0 (2026-08-23) — 71,700+ lines of Zig (46,900+ production + 24,800+ tests across 331 `.zig` files), 2,092 unit tests, 85 lint rules, 112 `REVERSE_MAP` entries, 39 golden inputs (36 runner-covered suites), 12 generators × 6 dialects.
...
| Maintenance & Release Hygiene | ✅ Complete (12/12) | 12/12 | 0 |
| **Total** | | **160/160** | **0** |
