...
**Current version**: 0.329.0 (2026-08-23) — 71,400+ lines of Zig (46,700+ production + 24,700+ tests across 330 `.zig` files), 2,085 unit tests, 85 lint rules, 112 `REVERSE_MAP` entries, 37 golden test suites (36 runner-covered), 12 generators × 6 dialects.
...
| Maintenance & Release Hygiene | ✅ Complete (10/10) | 10/10 | 0 |
| **Total** | | **158/159** | **1** |
